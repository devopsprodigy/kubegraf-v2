                ...
                <div className="page-header">
                    <div className="page-header__inner">
                        <span className="page-header__logo">
                            <img className="page-header__img" src="public/plugins/devopsprodigy-kubegrafv2-app/img/grafanaLogo.png" alt="logo of DevOpsProdigy KubeGraf 2.0" />
                        </span>
                        <div className="page-header__info-block">
                            <h1 className="page-header__title">
                                <a className="page-header__link" href="plugins">Plugins</a><span> / DevOpsProdigy KubeGraf 2.0</span>
                            </h1>
